...
use \Bitrix\Main\{Grid, Grid\Panel\Snippet\Onchange, Grid\Panel\Actions};

$grid_options = new Grid\Options('report_listing');
$sort = $grid_options->GetSorting(['sort' => ['ID' => 'DESC'], 'vars' => ['by' => 'by', 'order' => 'order']]);
$nav_params = $grid_options->GetNavParams();

$nav = new Bitrix\Main\UI\PageNavigation('report_listing');
